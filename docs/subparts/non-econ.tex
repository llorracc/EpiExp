...
This section highlights elements of epidemiological modeling in other fields that might be of most value to economists.   \ifthenelse{\boolean{inBook}}{}{(See the literature map in Figure \ref{fig:graph_other}).}  We focus on the following three areas:
