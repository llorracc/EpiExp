      ...
      \parbox{0.9\textwidth}{
        \begin{center}
          \begin{tabbing}
            ...
            \texttt{~~~~~~PDF:~} \> \> \texttt{\href{https://github.com/\owner/EpiExp/blob/master/docs/EpiExp.pdf}{EpiExp_Book.pdf}} \\
            \texttt{~NBER~PDF:~} \> \> \texttt{\href{https://github.com/\owner/EpiExp/blob/master/docs/EpiExp.pdf}{EpiExp_NBER.pdf}} \\
