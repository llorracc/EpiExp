...
\begin{verbatimwrite}{./thankstext}
  \newcommand{\thankstext}{Thanks to the participants in the \textit{Handbook of Economic Expectations} Conference for insightful comments, and the editors for comments that substantially improved the paper.  Thanks also to Sebastian Benthall, Francesco Bianchi, Jennifer Manning, and Adrian Monninger for feedback on earlier drafts, Charles Manski, Matthew Jackson, Robert Shiller, David,Hirshleifer, Cars Hommes, Leif Anders Thorsrud, Byoung-Hyoun Hwang, Cris Moore for further comments, and special thanks to Mridul Seth for help in using the \texttt{\href{https://ndlib.readthedocs.io}{NDLib}} and \texttt{\href{https://networkx.org/}{NetworkX}} python libraries to produce our \href{https://econ-ark.org/materials/epiexp?launch}{SIR Model Notebook}.}
\end{verbatimwrite}
\begin{verbatimwrite}{./thanks}
  \begin{center}
...
\begin{verbatimwrite}{./Slides/QuoteSimon1984}
  \begin{quote}\ifthenelse{\boolean{Slides}}{\footnotesize}{}
    ...
    \medskip
    \indent -- \IfPrivate{\href{https://econpapers.repec.org/RePEc:eee:jeborg:v:5:y:1984:i:1:p:35-55}{
...
\begin{verbatimwrite}{./Slides/QuoteShiller2017}
  \begin{quote}\ifthenelse{\boolean{Slides}}{\footnotesize}{}
    ...
    \medskip
    \indent -- \IfPrivate{\href{https://www.amazon.com/dp/B07VZWLRM8/ref=cm_sw_em_r_mt_dp_BT5KE0VTHQX6DJ35FD9C}{\cite{shiller2017narrative}}}{\cite{shiller2017narrative}}
  \end{quote}
\end{verbatimwrite}
...
\begin{verbatimwrite}{./authorsinfo}
  \begin{authorsinfo}
...
%  \input{./authorsinfo}
  ...
  \chapter[Chapter Title]{Epidemiological \\ Expectations\footnote{\thankstext}w}\label{chap1}
...
\providecommand{\forcedate}{October 23, 2022}
...
Options proliferate from there.\footnote{For a general introduction to these model basics, we refer the reader to \href{https://en.wikipedia.org/wiki/Compartmental_models_in_epidemiology\#Transition_rates}{this Wikipedia page}.  Prominent examples include	 \IfPrivate{\href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3710332/}{\cite{bailey1975mathematical}}}{\cite{bailey1975mathematical}}, \IfPrivate{\href{https://www.amazon.com/Infectious-Diseases-Humans-Dynamics-Control/dp/019854040X}{\cite{anderson_infectious_1992}}}{\cite{anderson_infectious_1992}}, \IfPrivate{\href{https://epubs.siam.org/doi/abs/10.1137/S0036144500371907}{\cite{hethcote_mathematics_2000}}}{\cite{hethcote_mathematics_2000}}, \IfPrivate{\href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6001967/}{\cite{brauer2017mathematical}}}{\cite{brauer2017mathematical}}.}  A framework in which there are two possible outcomes of the infection, recovery or death, receives the acronym SIRD.  If the disease is one in which it is necessary to track the proportion who have been Exposed but are not yet (and may never become) infected, the result is an SEIR model -- and so on.
...
\begin{comment}% Not sure what good this "plausible applications" section does here -- maybe move to conclusion?
  ...
  A highly cited example \cite{bauckhage2011insights} uses a variety of epidemiological models in an attempt to explain the dynamics of
 internet ``memes.'' The attempt meets with some success in the sense that the author finds some examples in which one of the many
